...
namespace PedidoServidor.SQL_Datos_y_Entity
{
    public class Datos
    {
        /*
        INSERT INTO dbo.Especificacion_Articulo(Codigo, Nombre, Descripcion)
        VALUES('1000', 'Pelota Adidas', 'Pelota adidas con logo grabado');

        INSERT INTO dbo.Especificacion_Articulo(Codigo, Nombre, Descripcion)
        VALUES('1001', 'Vaca Lola', 'Vaca Lola de la granga de xenon');

        INSERT INTO dbo.Especificacion_Articulo(Codigo, Nombre, Descripcion)
        VALUES('1002', 'Percheron', 'Percheron de la granga de xenon');

        INSERT INTO dbo.Especificacion_Articulo(Codigo, Nombre, Descripcion)
        VALUES('1003', 'Toy Story 4', 'Muñec de toy story 4 con musica');
